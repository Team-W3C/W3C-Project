        ...
        <section class="member-info-content">
                    ...
                    <ul class="info-list">
                        <li class="info-item">
                            ...
                            <div class="info-value-box">
                                <span id="name">김환자</span>
                            </div>
                        </li>
                        <li class="info-item">
                            <label for="birthdate" class="info-label">생년월일</label>
                            <div class="info-value-box">
                                <span id="birthdate">1990-03-15</span>
                            </div>
                        </li>
                        <li class="info-item">
                        ...
                        <li class="info-item">
                            ...
                            <div class="info-value-box">
                                <span id="email">patient@example.com</span>
                            </div>
                        </li>
                        <li class="info-item address-item">
                            ...
                            <div class="info-value-group">
                                <div class="info-value-box">
                                    <span id="address1">서울시 종로구 대학로 101</span>
                                </div>
                                <div class="info-value-box">
                                    <span id="address2">서울대학병원 3층</span>
                                </div>
                            </div>
                        </li>
                        <li class="info-item">
                            ...
                            <div class="info-value-box">
                                <span id="join-date">2023-05-20</span>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <section class="info-section account-management">
                ...
                <div class="info-section-body">
                    <h4>회원 탈퇴</h4>
                    <p class="description">
                        회원 탈퇴 시 모든 개인정보와 진료 기록이 삭제되며, 복구가 불가능합니다. 신중하게 결정해 주시기 바랍니다.
                    </p>
        ...
        <div class="withdrawal-form">
            <div class="info-card">
                ...
                <div class="info-content">
                    ...
                    <span class="info-value">2025.10.29.수</span>
                </div>
            </div>
            <div class="info-card">
                <div class="info-icon">
