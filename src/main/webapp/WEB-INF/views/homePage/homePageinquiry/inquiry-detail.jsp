...
<main class="inquiry-detail-main">
    ...
    <div class="inquiry-detail-actions">
        <button class="inquiry-detail-back-btn" type="button" aria-label="목록으로 돌아가기"
                onclick="location.href='${pageContext.request.contextPath}/member/inquiry-board.bo'">
...
추가 접수: 진료가 가능하다면, 어깨/목 통증에 대한 정형외과 추가 접수를 도와드릴 것입니다.</div>
    ...
    <!-- 하단 목록으로 버튼 -->
    <button class="inquiry-detail-footer-btn" type="button" onclick="location.href='${pageContext.request.contextPath}/member/inquiry-board.bo'">
        목록으로 돌아가기
    </button>
