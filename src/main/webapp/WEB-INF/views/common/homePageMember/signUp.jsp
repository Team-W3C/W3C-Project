...
<body>
    ...
    <main class="signup-main">
        <div class="signup-container">
            ...
            <form class="signup-form" method="post" action="${pageContext.request.contextPath}/member/signUp.me">
                <!-- 아이디 -->
                ...
                <div class="blood-ssn-container">
                    ...
                    <div class="signup-field-ssn">
                        <div class="signup-field-group">
                            ...
                            <input type="text" id="ssnFront" name="memberRrnFront" class="signup-input signup-input-ssn" placeholder="주민등록번호" maxlength="6">
                        </div>
                        <span class="signup-ssn-dash">-</span>
                        <input type="password" id="ssnBack" name="memberRrnBack" class="signup-input signup-input-ssn" placeholder="뒷자리" maxlength="7">
                    </div>
                ...
                <div class="email-notes-container">
                    ...
                    <div class="signup-field-group signup-field-notes">
                        ...
                        <input type="text" id="notes" name="memberNote" class="signup-input signup-input-short" placeholder="특이사항">
                    </div>
                </div>
