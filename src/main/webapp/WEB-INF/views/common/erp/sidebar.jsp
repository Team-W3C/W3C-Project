...
<%--            커뮤니티--%>
            <a href="${pageContext.request.contextPath}/erp/erpNotice/notice?cpage=1" class="sidebar__link">
                <svg class="sidebar__icon" width="20" height="20" fill="none" viewBox="0 0 20 20">
            ...
            <a href="${pageContext.request.contextPath}/erp/setting" class="sidebar__link">
                <svg class="sidebar__icon" width="20" height="20" fill="none" viewBox="0 0 20 20">
