    ...
    <main class="employee-main">
      ...
      <section class="employee-stats">
        <div class="employee-stat-card">
          ...
          <p class="employee-stat-value">127명</p>
        </div>
        <div class="employee-stat-card">
          <p class="employee-stat-label">근무 중</p>
          <p class="employee-stat-value">98명</p>
        </div>
        <div class="employee-stat-card">
          <p class="employee-stat-label">휴가 중</p>
          <p class="employee-stat-value">8명</p>
        </div>
        <div class="employee-stat-card">
          <p class="employee-stat-label">퇴사</p>
          <p class="employee-stat-value">42명</p>
        </div>
      </section>
      ...
      <section class="employee-search-section">
        <div class="employee-search-wrapper">
          ...
          <button class="employee-btn-search">검색</button>
      ...
      <section class="employee-table-section">
          ...
          <table class="employee-table">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <span class="employee-badge employee-badge-working"
                    >근무 중</span
                  >
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  <span class="employee-badge employee-badge-vacation"
                    >휴가 중</span
                  >
                </td>
                <td>
        ...
        <div class="employee-pagination">
          <p class="employee-pagination-info">총 127명 중 1-5명 표시</p>
