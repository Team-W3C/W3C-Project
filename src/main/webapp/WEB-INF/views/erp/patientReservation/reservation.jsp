                ...
                <div class="form-row">
                            ...
                            <div class="calendar-header">
                                <button class="calendar-nav" id="prevMonth">
                                    <svg width="16" height="16" viewBox="0 0 6 10" fill="none">
                                        <path d="M4.66667 8.66667L0.666667 4.66667L4.66667 0.666667" stroke="#6B7280" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </button>
                                <span class="calendar-month" id="calendarMonth">October 2025</span>
                                <button class="calendar-nav" id="nextMonth">
                                    <svg width="16" height="16" viewBox="0 0 6 10" fill="none">
                                        <path d="M0.666667 8.66667L4.66667 4.66667L0.666667 0.666667" stroke="#6B7280" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </button>
                            </div>
                    ...
                    <div class="form-group half">
                        <label class="form-label">
                            예약 시간
                            <span class="required">*</span>
                            <span class="selected-count" id="selectedCount">(2개 선택됨)</span>
                        </label>
                        <div class="time-container">
                                    ...
                                    <div class="time-badge" data-time="09:00">
                                        ...
                                        <button class="remove-time">
                                            <svg width="12" height="12" viewBox="0 0 7 7" fill="none">
                                                <path d="M6.5 0.5L0.5 6.5" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                                                <path d="M0.5 0.5L6.5 6.5" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                        </button>
                                    </div>
                            ...
                            <div class="time-slots" id="timeSlots">
                                <button class="time-slot selected" data-time="09:00">09:00</button>
                                <button class="time-slot selected" data-time="09:30">09:30</button>
