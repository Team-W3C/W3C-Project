        ...
        <section class="attendance-widget">
            <ul class="widget-stats-list">
                <li>
                    ...
                    <strong class="value" id="current-time"></strong>
                </li>
                <li>
                    <span class="label">출근 시각</span>
                    <strong class="value">
                        <c:choose>
                            <c:when test="${not empty todayRecord.absenceStart}">
                                ${todayRecord.absenceStart.toLocalTime()}
                            </c:when>
                ...
                <li>
                    ...
                    <strong class="value">
                        <c:choose>
                            <c:when test="${not empty todayRecord.absenceEnd}">
                                ${todayRecord.absenceEnd.toLocalTime()}
                            </c:when>
                            <c:otherwise>-</c:otherwise>
                        </c:choose>
                    </strong>
                ...
                <li>
                    ...
                    <strong class="value">${not empty todayRecord.workHours ? todayRecord.workHours : '-'}시간</strong>
                </li>
            </ul>
            <c:choose>
                        ...
                        <table class="attendance-history-table">
                            ...
                            <c:forEach var="item" items="${historyList}">
                                <tr>
                                    ...
                                    <td>
                                            ${item.absenceStart.toLocalTime()}
                                    </td>
                                    <td>
                                            ${item.absenceEnd.toLocalTime()}
                                    </td>
                            ...
                            <article class="application-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:when test="${app.absenceType == 1}">
                                            <c:set var="reasonParts" value="${fn:split(app.detailedReason, '|')}" />
                                            <dl>
                                                <dt>기간</dt>
                                                <dd>
                                                        ${app.absenceStartDate} <br/>
                                                        ${reasonParts[0]}
                                                </dd>
                                            </dl>
                                            <dl>
                                        ...
                                        <c:otherwise>
                                            <dl>
                                                <dt>기간</dt>
                                                <dd>
                                                        ${app.absenceStartDate} ~ ${app.absenceEndDate}
                                                </dd>
                                            </dl>
                                            <dl>
                                                <dt>사유</dt>
                            ...
                            <c:forEach
                                ...
                                <li class="request-card">
                                    <div class="card-content">
                                        ...
                                        <div class="card-header">
                                            <div class="user-info">
                                                ...
                                                <div class="user-details">
                                                    ...
                                                    <span class="dept">${item.departmentName} · ${item.staffNo}</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <c:choose>
                                                <%-- 1. 외출(Type 1)일 경우 --%>
                                                <c:when test="${item.absenceType == 1}">
                                                    <c:set var="reasonParts" value="${fn:split(item.detailedReason, '|')}" />
                                                    <dl>
                                                        <dt>기간</dt>
                                                        <dd>
                                                                ${item.absenceStartDate} <br/>
                                                                ${reasonParts[0]}
                                                        </dd>
                                                    </dl>
                                                    <dl>
                                                ...
                                                <c:otherwise>
                                                    <dl>
                                                        <dt>기간</dt>
                                                        <dd>
                                                                ${item.absenceStartDate} ~ ${item.absenceEndDate}
                                                        </dd>
                                                    </dl>
                                                    <dl>
                                                        <dt>신청 일시</dt>
                                    ...
                                    <div class="card-actions">
                                        <form action="${pageContext.request.contextPath}/erp/attendance/admin/updateStatus"
                                              method="post" style="display: inline;">
                                            <input type="hidden" name="addNo" value="${item.addNo}">
                                            <input type="hidden" name="status" value="T"> <%-- T: 승인 --%>
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="card-header">
                                            <div class="user-info">
                                                ...
                                                <div class="user-details">
                                                    <span class="name">${item.employeeName}</span>
                                                    <span class="dept">${item.departmentName}</span>
                                                </div>
                                            </div>
                                            <c:choose>
                                                <c:when test="${item.absenceType == 1}">
...
<div id="application-modal" class="modal-overlay">
    ...
    <div class="modal-content application-page">
        ...
        <div class="modal-header">
            ...
            <button type="button" id="close-application-modal-btn" class="modal-close-btn">&times;</button>
        </div>

        <%-- 신청서 폼 --%>
        <form class="application-form" action="${pageContext.request.contextPath}/erp/attendance/apply" method="post">
            <input type="hidden" id="application-type" name="applicationType" value="outing">

            <%-- 1. 신청자 정보 --%>
            <section
                    class="application-form-header">
                <div class="form-group">
                    <label for="applicant-name" class="form-label">신청자</label>
                    <input type="text" id="applicant-name" class="form-control" value="${loginUser.memberName}" readonly>
                </div>
                <div class="form-group">
                    <label for="applicant-dept" class="form-label">소속</label>
                    <input type="text" id="applicant-dept" class="form-control" value="${loginUser.departmentName}" readonly>
                </div>
                <div class="form-group">
                    <label for="applicant-position" class="form-label">직위</label>
                    <input type="text" id="applicant-position" class="form-control" value="${loginUser.positionName}" readonly>
                </div>
            </section>
                ...
                <div class="tab-content-container">
                    ...
                    <div id="tab-content-outing" class="tab-pane is-active">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-inline">
                                <input type="time" id="outing-start-time" name="outingStartTime" class="form-control" value="14:00">
                                <span>~</span>
                                <input type="time" id="outing-end-time" name="outingEndTime" class="form-control" value="16:00">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="outing-reason" class="form-label">사유</label>
                            <textarea id="outing-reason" name="outingReason" class="form-control" rows="5" placeholder="사유를 입력하세요"></textarea>
                        </div>
                    </div>
                    ...
                    <div id="tab-content-leave" class="tab-pane">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-inline">
                                <input type="date" id="leave-start-date" name="leaveStartDate" class="form-control">
                                <span>~</span>
                                <input type="date" id="leave-end-date" name="leaveEndDate" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="leave-reason" name="leaveReason" class="form-control" rows="5" placeholder="사유를 입력하세요"></textarea>
                        </div>
                    </div>
                    ...
                    <div id="tab-content-overnight" class="tab-pane">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-inline">
                                <input type="date" id="overnight-start-date" name="overnightStartDate" class="form-control">
                                <span>~</span>
                                <input type="date" id="overnight-end-date" name="overnightEndDate" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="overnight-reason" name="overnightReason" class="form-control" rows="5"
