        ...
        <section class="attendance-widget">
            <ul class="widget-stats-list">
                ...
                <li>
                    ...
                    <strong class="value">${not empty todayRecord.workHours ?
                                ...
                                <li class="request-card">
                                    ...
                                    <div class="card-actions">
                                        ...
                                        <form action="${pageContext.request.contextPath}/erp/attendance/admin/updateStatus"
                                            ...
                                            <input type="hidden" name="addNo" value="${item.addNo}">
                                            <input type="hidden" name="status" value="R"> <%-- R: 반려(거절) --%>
                ...
                <div class="tab-content-container">
                    ...
                    <div id="tab-content-outing" class="tab-pane is-active">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="outing-reason" name="reason" class="form-control" rows="5" placeholder="사유를 입력하세요"></textarea>
                    ...
                    <div id="tab-content-leave" class="tab-pane">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="leave-reason" name="reason" class="form-control" rows="5" placeholder="사유를 입력하세요"></textarea>
                    ...
                    <div id="tab-content-overnight" class="tab-pane">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="overnight-reason" name="reason" class="form-control" rows="5" placeholder="사유를 입력하세요"></textarea>
                        </div>
