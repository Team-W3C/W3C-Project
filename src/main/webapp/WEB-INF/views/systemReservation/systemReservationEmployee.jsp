...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/systemReservationEmployee.css">
</head>
<body>
...
<script src="${pageContext.request.contextPath}/js/systemReservationEmployee.js"></script>
